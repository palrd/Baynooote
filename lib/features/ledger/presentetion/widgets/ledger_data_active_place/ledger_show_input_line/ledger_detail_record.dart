              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: _buildTypeChoiceButton(),
                  ),
                  Expanded(
                    child: Container(
                      alignment: Alignment.center,
                      child: _buildRecordDetailButton(),
                    ),
                  ),
                ],
              ),
    ...
    return AnimatedBuilder(
      ...
      child: BaynoooteChoiceContainer(
        ...
        icon: SvgPicture.asset(
          ...
          width: 23,
          height: 23,
          colorFilter: ColorFilter.mode(Color(0xFF50A7EA), BlendMode.srcIn),
        ),
      ),
      builder: (_, child) {
        return Transform(
